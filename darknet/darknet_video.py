...
# Function to convert video path from string to integer if needed
...
# Function to check for argument errors
...
# Function to convert bbox coordinates to relative coordinates
...
# Function to convert bbox coordinates to original frame coordinates
